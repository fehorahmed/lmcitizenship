                        ...
                        <form action="" method="POST">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <div class="row mb-3">
                                        <label for="rate" class="col-12 col-md-3 col-form-label">Certificate
                                            value</label>
                                    ...
                                    <div class="row mb-3">
                                        <label for="dc_rate" class="col-12 col-md-3 col-form-label">Digital Center
                                            Commission</label>
                                        <div class="col-12 col-md-9">
                                        ...
                                        <div class="card-body">
                                            <div class="row mb-3">
                                                ...
                                                <label for="singtur_one_text"
                                                    class="col-12 col-md-3 col-form-label">Signature Name</label>
                                                <div class="col-12 col-md-9">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <label for="singtur_one_img"
                                                    class="col-12 col-md-3 col-form-label">Signature Image link</label>
                                                <div class="col-12 col-md-9">
