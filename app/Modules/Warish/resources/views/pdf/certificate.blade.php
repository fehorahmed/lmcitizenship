    ...
    @if (Route::has('login'))
            ...
            <div style="width: 70%; margin:auto;  line-height:26px">
                ...
                <p class="para" style="font-size: 16px;">
                    ...
                    <u>{{ isset($fdata->ward->bn_name) ? e_to_b($fdata->ward->bn_name) : $fdata->ward->name }}</u> নং ওয়ার্ডের
                    অন্তর্গত <u>{{ isset($fdata->moholla->bn_name) ? $fdata->moholla->bn_name : $fdata->moholla->name }}</u> গ্রাম/মহল্লা নিবাসী
