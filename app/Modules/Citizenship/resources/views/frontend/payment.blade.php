            ...
            <div class="row up_bottom" style="margin-top: 20px;">
                <div class="col-md-12">
                    <form action="{{ route('citizenship.payment') }}" method="POST" enctype="multipart/form-data">
                        ...
                        @include('Citizenship::frontend.part.details', ['fdata' => $fdata,'user'=>$user])
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div id="my-app">
                                            <div class="modal-body">
                                                    ...
                                                    <div class="radio">
                                                        <label>
                                                            <input type="radio" name="payment_info[payment_method]"
                                                                ...
                                                                onchange="paymentMethod(this,2)" data-id="1">
                                                            বিকাশ
                                                        </label>
                                                    </div>
                                                    <div class="radio">
                                                        <label>
                                                            <input type="radio" name="payment_info[payment_method]"
                                                                ...
                                                                onchange="paymentMethod(this,3)" data-id="1">
                                                            নগদ
                                                        </label>
                                                    </div>
                                                    <div class="radio">
                                                        <label>
                                                            <input type="radio" name="payment_info[payment_method]"
                                                                ...
                                                                onchange="paymentMethod(this,4)" data-id="1" checked>
                                                            ক্যাশ
                                                        </label>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group" style="margin-bottom: 5px">
                                                            ...
                                                            <input type="text" name="payment_info[date]"
                                                                id="payment_info_date" class="form-control g-date-pick"
                                                ...
                                                <div class="form-group">
                                                    <label for="remarks" class="remarks cmmone-class">মন্তব্য</label>
                                                    <input type="text" class="form-control" name="payment_info[notes]"
                                                        id="payment_info_notes" placeholder="মন্তব্য...">
