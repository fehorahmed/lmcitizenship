        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Profession Create</h4>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-8 m-auto">
                <div class="card">
                    <div class="card-header bg-info ">
                        <h4 class=" text-white content-center">Profession Create</h4>
                    </div>
                    <div class="card-body">
                        <form id="campaign-form" class="form-horizontal" method="post"
                            action="{{ route('admin.config.profession.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-12 col-md-9">
                                    ...
                                    <label for="status2">Inactive</label> <input id="status2" type="radio"
                                        {{ old('status') == '0' ? 'checked' : '' }} name="status" value="0">
                                    @error('status')
                                        <div class="help-block text-danger">{{ $message }} </div>
                                    @enderror
                                </div>
                            ...
                            <div class="text-center mb-3">
                                ...
                                <input type="submit" class="btn btn-primary  " value="Add Profession">
                            </div>
                        </form>
                    </div>
                </div>
