                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="campaign-form" class="form-horizontal" method="post"
                            action="{{ route('admin.config.union.edit',$union->id) }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                                ...
                                <div class="col-12 col-md-9">
                                    <select name="division" id="division" class="form-select">
                                        ...
                                        @foreach ($divisions as $division)
                                            <option {{ old('division',$union->upazila->district->division->id) == $division->id ? 'selected' : '' }}
                                                value="{{ $division->id }}">{{ $division->name }} - {{ $division->bn_name }}</option>
                                        @endforeach
                                    </select>
                                    @error('division')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" name="name" id="name" value="{{ old('name',$union->name) }}"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" name="bn_name" id="bn_name" value="{{ old('bn_name',$union->bn_name) }}"
...
@push('scripts')
    <script>
        $(function() {
            var districtSelected = '{{ old('district',$union->upazila->district->id) }}'
            ...
            var subDistrictSelected = '{{ old('sub_district',$union->upazila->id) }}';
