                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="campaign-form" class="form-horizontal" method="post"
                              action="{{route('admin.config.trainer.update',$data->id)}}"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" name="code" value="{{old('code',$data->code)}}" id="code"
                            ...
                            <div class="row mb-3">
                                <label for="example-select" class="col-12 col-md-3 col-form-label">Trainer
                                    Organization</label>
                                <div class="col-12 col-md-9">
                                    <select name="training_organization" class="form-select" id="training_organization">
                                        ...
                                        @foreach(\App\Models\TrainerOrg::where('status',1)->get() as $org)
                                            <option
                                                {{old('training_organization',$data->trainer_org_id)==$org->id ? 'selected':''}} value="{{$org->id}}">{{$org->name}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row mb-3">
                                <label for="example-select" class="col-12 col-md-3 col-form-label">Zone Mail</label>
                                <div class="col-12 col-md-9">
                                    <input type="email" name="email" value="{{old('email',$data->email)}}" id="email"
                                           class="form-control" placeholder="Zone email">
                                    @error('email')
                                    <div class="help-block text-danger">{{ $message }} </div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" name="designation" id="designation" value="{{old('designation',$data->designation)}}"
                            ...
                            <div class="row mb-3">
                                <label for="example-select" class="col-12 col-md-3 col-form-label">Zone Phone</label>
                                <div class="col-12 col-md-9">
                                    <input type="number" name="mobile" id="mobile" value="{{old('mobile',$data->mobile)}}"
                                           class="form-control" placeholder="Zone mobile number">
                                    @error('mobile')
                                    <div class="help-block text-danger">{{ $message }} </div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <textarea name="address" class="form-control" id="address" cols="10"
                                          rows="3"
                                          placeholder="Enter zone address">{{old('address',$data->address)}}</textarea>
                                    @error('address')
                                    <div class="help-block text-danger">{{ $message }} </div>
                                    @enderror
                                </div>
                            ...
                            <div class="text-center mb-3">
                                <a href="{{route('admin.config.trainer.index')}}" class="btn btn-danger">Back</a>
