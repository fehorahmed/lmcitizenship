                        ...
                        <form id="campaign-form" class="form-horizontal" method="post"
                                ...
                                <div class="col-12 col-md-9">
                                    <select name="division" id="division" class="form-select">
                                        ...
                                        @foreach ($divisions as $division)
                                            <option {{ old('division',$user->division_id) == $division->id ? 'selected' : '' }}
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-12 col-md-9">
                                    <select name="role" id="role" class="form-select">
                                        ...
                                        <option {{ old('role',$user->role) == 1 ? 'selected' : '' }} value="1">User</option>
                                        <option {{ old('role',$user->role) == 2 ? 'selected' : '' }} value="2"> Admin</option>
                                        <option {{ old('role',$user->role) == 3 ? 'selected' : '' }} value="3">Super Admin</option>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-12 col-md-9">
                                    ...
                                    @enderror
                                    @if ($user->signature)
                                    <img src="{{asset($user->signature)}}" alt="" height="50px" width="200px">
                                    @endif
...
@push('scripts')
    <script>
        $(function() {
            var districtSelected = '{{ old('district',$user->district_id) }}'
            ...
            var subDistrictSelected = '{{ old('sub_district',$user->sub_district_id) }}';
