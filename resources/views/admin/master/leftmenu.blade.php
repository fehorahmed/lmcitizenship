    ...
    <div class="h-100" id="leftside-menu-container" data-simplebar>
        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarDashboards">
                    <ul class="side-nav-second-level">
                        ...
                        <li>
                            <a href="{{ route('admin.citizenship.make-payment') }}">Make Payment</a>
                        </li>
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="WarishDashboards">
                    <ul class="side-nav-second-level">
                        <li>
                            <a href="{{ route('admin.warish.index') }}">All List</a>
                        </li>
                        <li>
                            <a href="{{ route('admin.warish.setting') }}">Setting</a>
                        </li>
            ...
            <li class="side-nav-item">
                <a href="{{ route('admin.config.union.index') }}" class="side-nav-link">
                    <i class="uil uil-tachometer-fast"></i>
                    <span> Powrosova List </span>
                </a>
            </li>
            <li class="side-nav-item">
                <a href="{{ route('admin.config.ward.index') }}" class="side-nav-link">
                    <i class="uil uil-tachometer-fast"></i>
                    <span> Ward List </span>
                </a>
            </li>
            <li class="side-nav-item">
                <a href="{{ route('admin.config.moholla.index') }}" class="side-nav-link">
                    <i class="uil uil-tachometer-fast"></i>
                    <span> Moholla List </span>
                </a>
            </li>
            <li class="side-nav-item">
                <a href="{{ route('admin.config.post.index') }}" class="side-nav-link">
                    <i class="uil uil-tachometer-fast"></i>
                    <span> Post Office List </span>
                </a>
            </li>
            ...
            <li class="side-nav-item">
                <a href="{{ route('admin.admin.index') }}" class="side-nav-link">
                    <i class="uil uil-tachometer-fast"></i>
                    <span> Admins </span>
                </a>
            </li>
            ...
            <li class="side-nav-title side-nav-item">Application Setting</li>
            ...
            <li class="side-nav-item">
             ...
             <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarEcommerce">
                    <ul class="side-nav-second-level">
                        <li>
                            <a href="{{route('admin.front-dashboard.list-of-person.index')}}"> List Of Content</a>
                        </li>
                        <li>
