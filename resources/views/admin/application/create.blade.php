                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="campaign-form" class="form-horizontal" method="post"
                              action="{{route('admin.complain.store')}}"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="row mb-3">
                                        <label for="example-select" class="col-12 col-md-3 col-form-label">Father
                                            Name</label>
                                        <div class="col-12 col-md-9">
                                            <input type="text" name="f_name" value="{{old('f_name')}}" id="f_name"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="number" value="{{old('mobile')}}" name="mobile" id="mobile" class="form-control"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="number" name="nid" id="nid" value="{{old('nid')}}"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <textarea name="subject" id="subject" cols="5" class="form-control" rows="3"
                                                      placeholder="Write subject here">{{old('subject')}}</textarea>
                                            @error('subject')
                                            <div class="help-block text-danger">{{ $message }} </div>
                                            @enderror
                                        </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <select name="division" id="division" class="form-select" {{\Illuminate\Support\Facades\Auth::user()->role!=5?'disabled':''}}>
                                                <option value="">Select Division</option>
                                                @foreach($divisions as $division)
                                                    <option {{old('division',\Illuminate\Support\Facades\Auth::user()->division_id)==$division->id?'selected':''}} value="{{$division->id}}">{{$division->name}}</option>
                                                @endforeach
                                            </select>
                                            @error('division')
                                            <div class="help-block text-danger">{{ $message }} </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <select name="district" id="district" class="form-select" {{\Illuminate\Support\Facades\Auth::user()->role!=5?'disabled':''}}>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <textarea name="remark" class="form-control" id="remark" cols="10"
                                                      rows="3"
                                                      placeholder="Enter remarks here">{{old('remark')}}</textarea>
                                            @error('remark')
                                            <div class="help-block text-danger">{{ $message }} </div>
                                            @enderror
                                        </div>
