...
@section('content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">About Us Page</div>
        <div class="ps-3">
        ...
        <div class="col-xl-7 mx-auto">
            <div class="card">
                ...
                <div class="card-header bg-secondary">
                    <h4 class="card-title text-white">About US Update Form</h4>
                </div>
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('admin.about-us.store') }}" enctype="multipart/form-data"
                        ...
                        <div class="col-md-12">
                            ...
                            @if ($about->photo)
                                <img src="{{ asset('storage/' . $about->photo) }}" alt="" class="mt-1">
                            @endif
                        </div>
                        <div class="col-md-12">
                            <label for="text" class="form-label">Text <span class="text-danger">*</span></label>
                            <textarea name="text" id="text" class="form-control ck-editor" cols="30" rows="10">{{ old('text', $about->text ?? '') }}</textarea>
                            @error('text')
                                <div class="error">
                                    {{ $message }}
                                </div>
