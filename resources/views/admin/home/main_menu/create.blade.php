                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="campaign-form" class="form-horizontal" method="post"
                            action="{{ route('admin.main-menu.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-12 col-md-9">
                                    <select name="type" id="type" class="form-select">
                                        ...
                                        <option value="main" {{ old('type') == 'main' ? 'selected' : '' }}>Main Menu
                                        </option>
                                        <option value="sub" {{ old('type') == 'sub' ? 'selected' : '' }}>Sub Menu
                                        </option>
                                    </select>
                                    @error('type')
                                        <div class="help-block text-danger">{{ $message }} </div>
