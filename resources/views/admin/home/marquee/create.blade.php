        ...
        <div class="col-xl-7 mx-auto">
            <div class="card">
                ...
                <div class="card-header bg-secondary">
                    <h4 class="card-title text-white">Marquee Add Form</h4>
                </div>
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('admin.front-marquee.store') }}" enctype="multipart/form-data"
                        class="row g-3">
                        @csrf
                        <div class="col-md-12">
