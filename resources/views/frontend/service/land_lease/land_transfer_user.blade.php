...
@section('content')
    ...
    @php
        ...
        $transer_fee = get_land_transfer_fee($land->id);
    ...
    <div id="my-app">
        ...
        <div class="container">
            ...
            <div style="max-width: 550px; margin:  auto">
                ...
                {{Form::open(array('url' => 'land_transfer_aply', 'method' => 'post','autocomplete' => 'off'))}}

                <div class="modal-header">

                    <h4 class="modal-title" id="myModalLabel" style="text-align: center;">
                        ইজারাকৃত জমি হস্তান্তরের আবেদন।
                    </h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="input-group" style="margin-bottom: 5px">
                            ...
                            {{ Form::number('payment_info[form_fee]',$l_seting->transfer_apliction_fee, ['required', 'class' => 'form-control', 'placeholder' => 'টাকার পরিমাণ..','readonly']) }}
                    ...
                    <div class="form-group">
                        <div class="input-group" style="margin-bottom: 5px">
                            ...
                            {{ Form::number('payment_info[amount]',$transer_fee, ['required', 'class' => 'form-control', 'placeholder' => 'টাকার পরিমাণ..','readonly']) }}
                    ...
                    <div class="form-group">
                        <div class="input-group" style="margin-bottom: 5px">
                            ...
                            {{ Form::number('payment_info[total]',($l_seting->transfer_apliction_fee + $transer_fee), ['required', 'class' => 'form-control', 'placeholder' => 'টাকার পরিমাণ..','readonly']) }}
                    ...
                    <div class="form-group">
                        ...
                        {{ Form::hidden('land_id',Request::get('land'), ['required']) }}
                        {{ Form::hidden('user_id',Request::get('user'), ['required']) }}
                        {{ Form::hidden('lease_id',$user['lease_id'], ['required']) }}
