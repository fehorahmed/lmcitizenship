            ...
            <div class="row up_bottom">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">Present Address (In English)</div>
                        {{ Form::open(array('url' => '/present_address_en', 'method' => 'post', 'value' => 'PATCH', 'id' => 'general_info_en')) }}
                            ...
                            <div class="row">
                                <div class="col-xs-6">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('holding_no_en', !empty($user) ? $user->enpreholdingno : NULL, ['class' => 'form-control', 'placeholder' => 'Holding Number ']) }}
                                    </div>
                                </div>
                                <div class="col-xs-6">
                                    <div class="form-group">
                                        {{ Form::label('village_en', ' Village ', array('class' => 'village_en cmmone-class')) }}
                                        {{ Form::text('village_en', !empty($user) ? $user->enprevillage : NULL, ['required', 'class' => 'form-control', 'placeholder' => 'Village ']) }}
                                    </div>
                                </div>
                                <div class="col-xs-6">
                                    <div class="form-group">
                                ...
                                <div class="col-xs-6">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('ward_no_en',  !empty($user) ? $user->enprewardno : NULL, ['class' => 'form-control', 'placeholder' => ' Ward No']) }}
                                    </div>
                                </div>
                                <div class="col-xs-6">
                                    <div class="form-group">
                                        {{ Form::label('post_office_en', 'Post Office ', array('class' => 'post_office_en cmmone-class')) }}
                                        {{ Form::text('post_office_en',  !empty($user) ? $user->enprepostoffice : NULL, ['class' => 'form-control', 'placeholder' => 'Post Office']) }}
                                    </div>
                                </div>
