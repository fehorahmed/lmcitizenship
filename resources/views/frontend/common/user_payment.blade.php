...
<div class="container user_panel">
    ...
    if (!empty(request()->get('uid'))) {
        $user = \App\User::where('id', request()->get('uid'))->get()->first();
        //dd($user);
    } else {
        $user = Auth::user();
    }
    ...
    <div class="row up_bottom" style="margin-top: 20px;">
        <div class="col-md-12">
            <div class="panel panel-default commone-hean">
                ...
                {{ Form::open(array('url' => '/pay_now?service_route=' . $service->route, 'method' => 'post', 'value' => 'PATCH', 'id' =>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group">
                                <b> সেবা নামঃ {{$service->name }} {{ (request()->get('lang') == 'en')? ' (ইংরেজি) ': ' (বাংলা)'}}
                                    <hr></b>
                            ...
                            {{ Form::hidden('user_id', request()->get('uid'), ['required']) }}
                            {{ Form::hidden('digi_center_user_id', Auth::user()->id, ['required']) }}
                            {{ Form::hidden('service_id', request()->get('sid'), ['required']) }}
