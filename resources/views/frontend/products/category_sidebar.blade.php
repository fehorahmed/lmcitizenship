...
<div class="panel-group" id="accordionNo">
    ...
    <div class="panel panel-default side-bar-menu">
        ...
        <div id="categorization" class="panel-collapse collapse in">
            <div class="panel-body priceFilterBody pl-object">

                <div class="radio-item">
                    <input type="radio" id="material" name="material" value="all"
                    <?php echo((app('request')->input('material') == 'all') ? 'checked' : null) ?>>
                    <label for="ritem9">Any</label>
                </div>
                <br>
                <?php $materials = App\Product::select('material')->whereRaw('material IS NOT NULL')->groupBy('material')->get(); ?>
                @foreach($materials as $material)
                    <div class="radio-item">
                        <input type="radio" id="material" name="material"
                               value="{{ $material->material }}"
                        <?php echo((app('request')->input('material') == $material->material) ? 'checked' : null) ?>>
                        <label for="ritem8">{{ $material->material }}</label>
                    </div>
                    <br>
                @endforeach
